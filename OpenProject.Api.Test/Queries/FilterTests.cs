...
public class FilterTests
{
	...
	public void Filter_ToString_Succeeds()
	{
		...
		[
			new("subjectOrId", new OperatorValues { Operator = FilterOperator.SearchInAllStringAttributes, Values = ["12"] }),
			new("status", new OperatorValues { Operator = FilterOperator.EqualsOneOf, Values = ["5"] } ),
		]);
